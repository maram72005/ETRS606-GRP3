...
/******************************************************************************/
#define AI_METEO_MODEL_NAME          "meteo"
#define AI_METEO_ORIGIN_MODEL_NAME   "meteonet_stm32"

/******************************************************************************/
#define AI_METEO_ACTIVATIONS_ALIGNMENT   (4)
#define AI_METEO_INPUTS_IN_ACTIVATIONS   (4)
#define AI_METEO_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_METEO_IN_NUM        (1)

AI_DEPRECATED
#define AI_METEO_IN \
  ai_meteo_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_METEO_IN_SIZE { \
  AI_METEO_IN_1_SIZE, \
}
#define AI_METEO_IN_SIZE_BYTES { \
  AI_METEO_IN_1_SIZE_BYTES, \
}
#define AI_METEO_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_METEO_IN_1_CHANNEL     (27)
#define AI_METEO_IN_1_SIZE        (27)
#define AI_METEO_IN_1_SIZE_BYTES  (108)

/******************************************************************************/
#define AI_METEO_OUT_NUM       (1)

AI_DEPRECATED
#define AI_METEO_OUT \
  ai_meteo_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_METEO_OUT_SIZE { \
  AI_METEO_OUT_1_SIZE, \
}
#define AI_METEO_OUT_SIZE_BYTES { \
  AI_METEO_OUT_1_SIZE_BYTES, \
}
#define AI_METEO_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_METEO_OUT_1_CHANNEL     (6)
#define AI_METEO_OUT_1_SIZE        (6)
#define AI_METEO_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_METEO_N_NODES (8)
 ...
 * @ref ai_meteo_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_meteo_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_METEO_*
 * defines into file @ref meteo.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
